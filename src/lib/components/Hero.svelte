...
<section id="hero" class="bg-white pb-4 pt-10">
  <div class="container mx-auto max-w-4xl px-4">
    <div class="flex flex-col items-center justify-between md:flex-row">
      <div class="mb-6 w-full md:mb-0">
        <h1 class="mb-2 text-2xl font-bold text-gray-800 md:text-3xl">{profile.name}</h1>

        <!-- バイオを箇条書きからシングル段落に変更、タイトルと求職情報は不要（バイオ内に含まれる） -->
        <div class="mb-4">
          <p class="text-justify text-sm text-gray-700 md:text-base">{profile.bio}</p>
        </div>
        ...
        <div class="ml-2 flex flex-wrap gap-3">
          ...
          >
            ...
            >
              <path
                d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.5a1.5 1.5 0 110-3 1.5 1.5 0 010 3zM19 19h-3v-4.7c0-1.4-.7-1.8-1.5-1.8s-1.5.7-1.5 1.8V19h-3v-9h3v1.2a3 3 0 012.5-1.5c1.7 0 3.5 1.2 3.5 4v5.3z"
              />
            </svg>
            <!-- LinkedIn -->
          </a>
          ...
          <a
            href="https://orcid.org/0009-0004-7641-029X"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center text-sm text-primary transition-colors hover:text-primary-dark"
          >
          ...
          <a
            href="https://scholar.google.com/citations?user=2gp2WlEAAAAJ&hl=ja&authuser=1&oi=sra"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center text-sm text-primary transition-colors hover:text-primary-dark"
          >
          ...
          <a
            href="https://speakerdeck.com/tomonatu8"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center text-sm text-primary transition-colors hover:text-primary-dark"
          >
