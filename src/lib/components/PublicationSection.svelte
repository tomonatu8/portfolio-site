  ...
  <div class="space-y-1">
    {#each publications as pub}
      <div>
        ...
        <!-- 著者名 -->
        <p class="mb-0.5 ml-8 text-xs text-gray-700">
          {pub.authors}
        </p>

        <!-- 掲載情報（イタリック体で区別） -->
        <p class="mb-1 ml-8 text-xs italic text-gray-600">
          {pub.venue}
        </p>

        <!-- 研究キーワード（タグ表示） -->
        <div class="mb-3 ml-8 flex flex-wrap gap-1">
