<script lang="ts">
  ...
  // フィルター: 研究経験
  $: researchExperience = allExperience.filter(job => (job as any).experienceType === 'research');
</script>

<section id="research-experience" class="pt-0 pb-4 bg-white">
  <div class="container mx-auto px-4 max-w-4xl">
    <h2 class="section-title">{t(sectionTitles.researchExperience, $language)}</h2>
    
    <div class="content-container">
      <div class="space-y-0">
        {#each researchExperience as job}
          <div class="">
            <div class="">
              <div class="mb-2 ml-4">
