...
export const profile: LocalizedProfile = {
  ...
  // bioを配列からテキストに変更
  bio: bt(
    'I am a third-year Ph.D. Candidate in Information Science and Technology specializing in applied mathematics, optimization and mechanism design (matching/allocation). I have experience translating algorithms and AI systems into practical applications, with passion for bridging research with real-world implementation. I am seeking full-time positions from October 2025.',
    '私は応用数学、最適化、メカニズムデザイン（マッチング・配分）を専門とする情報理工学系研究科博士課程3年です。アルゴリズム・AIシステムの実用化経験があり、研究と実社会実装の架け橋に情熱を持っています。2025年10月以降のフルタイムポジションを探しています。'
  ),
  jobSeekingInfo: bt(
