...
<header
  class="sticky top-0 z-10 border-b border-gray-200 bg-white transition-transform duration-300 {isHeaderVisible
    ? ''
    : '-translate-y-full'}"
>
  <div class="container mx-auto px-4 py-3">
    <nav class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        ...
        <button
          class="rounded border border-gray-300 px-3 py-1 text-sm font-medium transition-colors hover:bg-gray-100"
...
<footer class="py-6 text-gray-600">
  <div class="container mx-auto px-4">
    <div class="flex justify-center">
      <p class="text-sm">
        © {new Date().getFullYear()} Tomohiko Yokoyama. {t(footer.copyright, $language)}
      </p>
    </div>
  </div>
</footer>
